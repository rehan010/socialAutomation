...
urlpatterns = [
    ...
    path('posts/comment/<int:post_id>/<int:page_id>', CommentPostApi.as_view(), name='comment_post'),
    path('posts/comment/paginate/<int:post_id>/<int:page_id>', CommentPagination.as_view(), name='comment_pagination'),
    path('posts/reply/<int:post_id>/<int:page_id>', ReplyPostApi.as_view(), name='reply_post'),
